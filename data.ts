...
export const data: PainType[] = [
  {
    ...
    exercise: [
      ...
      {
        url: "/neck4",
        name: "Flexiones profundas contraresistencia",
        difficulty: "medio",
      ...
      {
        url: "/neck6",
        name: "Flexion de cuello contraresistencia",
        difficulty: "medio",
      ...
      {
        url: "/neck7",
        name: "Extensión de cuello contraresistencia",
        difficulty: "medio",
      ...
      {
        url: "/neck10",
        name: "Isometria de cuello con movimiento de brazos",
        difficulty: "facil",
      ...
      {
        url: "/neck13",
        name: "Inclinasiones contra resistencia",
        difficulty: "dificil",
  ...
  },
  {
    ...
    exercise: [
      ...
      {
        url: "/knee4",
        name: "Sentadilla Isometrica unilateral",
        difficulty: "dificil",
      ...
      {
        url: "/knee11",
        name: "Gluteo medio de pie rodilla flexionada",
        difficulty: "medio",
  ...
  },
  {
    ...
    exercise: [
      ...
      {
        url: "/shoulder9",
        name: "Press militar en posicion de caballero unilateral",
        difficulty: "dificil",
      ...
      {
        url: "/shoulder10",
        name: "Rotación externa de hombros isometrica",
        difficulty: "facil",
      ...
      {
        url: "/shoulder11",
        name: "Rotación externa de hombros mancuerna",
        difficulty: "medio",
      ...
      {
        url: "/shoulder13",
        name: "Rotación interna isometrica con banda",
        difficulty: "medio",
      ...
      {
        url: "/shoulder14",
        name: "Rotación externa de hombros isometrica 90°",
        difficulty: "dificil",
  ...
  },
  {
    ...
    exercise: [
      ...
      {
        url: "/ankle4",
        name: "Eversión contraresistencia",
        difficulty: "medio",
      ...
      {
        url: "/ankle5",
        name: "Inversión Contraresistencia",
        difficulty: "medio",
      ...
      {
        url: "/ankle6",
        name: "Plantiflexión contraresistencia",
        difficulty: "medio",
  ...
  },
  {
    ...
    exercise: [
      ...
      {
        url: "/elbow8",
        name: "Extensión muñeca con banda",
        difficulty: "fácil",
